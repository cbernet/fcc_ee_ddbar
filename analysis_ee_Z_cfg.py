...
basedir = '/afs/cern.ch/user/c/cbern/FCC/fcc_ee_ddbar/samples/pythia'

import heppy.utils.absglob as absglob
import compfiles
ee_Z_ddbar = cfg.MCComponent(
    'ee_Z_ddbar',
    files = compfiles.get('{}/Z'.format(basedir)),
    )


ee_Z_ddbar.splitFactor = len(ee_Z_ddbar.files)
# ee_Z_ddbar.splitFactor = 1
